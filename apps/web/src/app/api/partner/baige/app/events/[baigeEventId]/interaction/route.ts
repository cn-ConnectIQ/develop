...
import { getBaigeAppEventInteraction } from "@/lib/integrations/baige-app-service";
import {
...
/** GET /api/partner/baige/app/events/{baigeEventId}/interaction?baigeOrgId= */
export const GET = withErrorHandler(
  async (request, context): Promise<NextResponse> => {
    ...
    try {
      const data = await getBaigeAppEventInteraction({
        baigeOrgId,
        baigeEventId,
      });
